...
global.socialm = process.env.SOCIAL_M || "GitHub: BrbBot69";
global.location = process.env.LOCATION || "South Africa, Johannesburg";

// Creator details
global.ownernumber = process.env.OWNER_NUMBER || '27767494368';
global.ownername = process.env.OWNER_NAME || '♤𝗑ᴾᴿᴼ♧';
global.botname = process.env.BOT_NAME || 'BALLAS𝗑ᴾᴿᴼ';
...
global.elitepropp = process.env.ELITE_PRO_PP || 'https://files.catbox.moe/zdf59d.jpg';
// Default emoji
...
global.link = process.env.LINK || 'https://whatsapp.com/channel/0029VbA9WaqEQIakf3fQFu1t';
